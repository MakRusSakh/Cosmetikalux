...
### 7.4 Особенности дизайна (отличие от основного каталога)

| Элемент | Основной каталог | Секция «Для мужчин» |
|---------|-----------------|---------------------|
| Фон hero | Gradient lavender-rose | Тёмный (#1A1A1A) + gold акцент |
| Типографика | Playfair обычный | Playfair bold, крупнее |
| Карточки | Стандартные ProductCard | Те же + бейдж «Для мужчин» |
| Навигация | Фильтры слева | Категории-иконки сверху |
| Сетка | 4 колонки | Группы + горизонтальный скролл |

### 7.5 Навигация — интеграция в меню
